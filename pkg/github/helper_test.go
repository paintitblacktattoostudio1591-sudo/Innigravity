...
const (
	...
	// Projects endpoints
	GetOrgsProjectsV2ByOrg                                      = "GET /orgs/{org}/projectsV2"
	GetUsersProjectsV2ByUsername                                = "GET /users/{username}/projectsV2"
	GetOrgsProjectsV2ByOrgByProjectNumber                       = "GET /orgs/{org}/projectsV2/{project_number}"
	GetUsersProjectsV2ByUsernameByProjectNumber                 = "GET /users/{username}/projectsV2/{project_number}"
	GetOrgsProjectsV2FieldsByOrgByProjectNumber                 = "GET /orgs/{org}/projectsV2/{project_number}/fields"
	GetUsersProjectsV2FieldsByUsernameByProjectNumber           = "GET /users/{username}/projectsV2/{project_number}/fields"
	GetOrgsProjectsV2FieldsByOrgByProjectNumberByFieldID        = "GET /orgs/{org}/projectsV2/{project_number}/fields/{field_id}"
	GetUsersProjectsV2FieldsByUsernameByProjectNumberByFieldID  = "GET /users/{username}/projectsV2/{project_number}/fields/{field_id}"
	GetOrgsProjectsV2ItemsByOrgByProjectNumber                  = "GET /orgs/{org}/projectsV2/{project_number}/items"
	GetUsersProjectsV2ItemsByUsernameByProjectNumber            = "GET /users/{username}/projectsV2/{project_number}/items"
	GetOrgsProjectsV2ItemsByOrgByProjectNumberByItemID          = "GET /orgs/{org}/projectsV2/{project_number}/items/{item_id}"
	GetUsersProjectsV2ItemsByUsernameByProjectNumberByItemID    = "GET /users/{username}/projectsV2/{project_number}/items/{item_id}"
	PostOrgsProjectsV2ItemsByOrgByProjectNumber                 = "POST /orgs/{org}/projectsV2/{project_number}/items"
	PostUsersProjectsV2ItemsByUsernameByProjectNumber           = "POST /users/{username}/projectsV2/{project_number}/items"
	PatchOrgsProjectsV2ItemsByOrgByProjectNumberByItemID        = "PATCH /orgs/{org}/projectsV2/{project_number}/items/{item_id}"
	PatchUsersProjectsV2ItemsByUsernameByProjectNumberByItemID  = "PATCH /users/{username}/projectsV2/{project_number}/items/{item_id}"
	DeleteOrgsProjectsV2ItemsByOrgByProjectNumberByItemID       = "DELETE /orgs/{org}/projectsV2/{project_number}/items/{item_id}"
	DeleteUsersProjectsV2ItemsByUsernameByProjectNumberByItemID = "DELETE /users/{username}/projectsV2/{project_number}/items/{item_id}"
