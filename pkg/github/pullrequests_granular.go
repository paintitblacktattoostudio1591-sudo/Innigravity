			...
			InputSchema: &jsonschema.Schema{
				...
				Properties: map[string]*jsonschema.Schema{
					...
					"reviewers": {
						...
						Items:       &jsonschema.Schema{Type: "string", Description: "GitHub username or ORG/team-slug team"},
					},
				},
		...
		mcp.Tool{
			...
			InputSchema: &jsonschema.Schema{
				...
				Properties: map[string]*jsonschema.Schema{
					...
					"repo":       {Type: "string", Description: "Repository name"},
					"pullNumber": {Type: "number", Description: "The pull request number", Minimum: jsonschema.Ptr(1.0)},
					"body":       {Type: "string", Description: "Review body (optional); Markdown supported"},
		...
		mcp.Tool{
			...
			InputSchema: &jsonschema.Schema{
				...
				Properties: map[string]*jsonschema.Schema{
					...
					"body":       {Type: "string", Description: "Review body; Markdown supported"},
				},
